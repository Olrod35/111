...
т.к. мы не храним данные пользователя в базе данных или файле мы имитируем такую ситуацию, в нашем случае
программа всегда будет выводить сообщение "Вы заблокированы! Следующая попытка через N мин."""